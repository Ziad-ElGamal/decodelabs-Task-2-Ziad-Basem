...
## Overview
This repository contains an advanced predictive classification model built during the DecodeLabs industrial training program. The objective of this project is to implement Supervised Learning to categorize data without relying on hard-coded heuristic rules. 
